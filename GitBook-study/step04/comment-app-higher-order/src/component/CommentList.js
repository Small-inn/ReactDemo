...
class CommentList extends Component {
    ...
    handleDelComm(index) {
        if (this.props.onDelCom) {
            this.props.onDelCom(index)
        }
    }
    render() {
        // const comments = [
        ...
        return (
            <div className="list_wrapper">
                {this.props.comments.map((item, i) => <Comment onDelCom={this.handleDelComm.bind(this)} comment={item} key={i} index={i} />)}
            </div>
        )
    }
}
